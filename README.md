...
>월간 데이콘 심리 성향 예측 AI 경진대회 자료([Dacon](https://dacon.io/competitions/official/235647/overview/description))
 이용
...
>코로나 데이터 시각화 AI 경진대회 자료([Kaggle](https://www.kaggle.com/datasets/kimjihoo/coronavirusdataset),[Dacon](https://dacon.io/competitions/official/235590/overview/description))
 이용
